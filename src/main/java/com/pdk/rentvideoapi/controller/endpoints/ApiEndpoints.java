...
public class ApiEndpoints {
    ...
    public static final String USER_API_ENDPOINT = RENTVIDEOAPP_API_ENDPOINT + "/auth/register";
    public static final String VIDEO_API_ENDPOINT = RENTVIDEOAPP_API_ENDPOINT + "/auth/videos";
    public static final String VIDEO_ADMIN_API_ENDPOINT = RENTVIDEOAPP_API_ENDPOINT + "/admin/videos";
